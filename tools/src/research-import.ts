...
async function processUrl(url: string, config: ReturnType<typeof setupConfig>): Promise<void> {
...
async function processPdf(pdfPath: string, config: ReturnType<typeof setupConfig>): Promise<void> {
