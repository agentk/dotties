...
brew "bc" # Arbitrary precision numeric processing language
...
brew "dosbox-x" # DOSBox with accurate emulation and wide testing
...
brew "rom-tools" # Tools for Multiple Arcade Machine Emulator
...
cask "marked-app" # Previewer for Markdown, MultiMarkdown and other text markup languages
...
cask "mini-vmac" # Allows modern computers to run software made for early Apple computers
cask "musicbrainz-picard" # Music tagger
cask "name-mangler" # Multi-file renaming tool
...
cask "openscad@snapshot" # Programmable solid 3D CAD modeller
...
cask "retroarch-metal" # Frontend for emulators, game engines and media players (Metal graphics API)
cask "reveal" # Powerful runtime view debugging for iOS developers
...
cask "transnomino" # Batch rename utility
